...
public class SwiftFlutterBarcodeScannerPlugin: NSObject, FlutterPlugin, ScanBarcodeDelegate,FlutterStreamHandler {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        let channel = FlutterMethodChannel(name: "flutter_smart_scan", binaryMessenger: registrar.messenger())
        let instance = SwiftFlutterBarcodeScannerPlugin()
        registrar.addMethodCallDelegate(instance, channel: channel)
        let eventChannel=FlutterEventChannel(name: "flutter_smart_scan_receiver", binaryMessenger: registrar.messenger())
